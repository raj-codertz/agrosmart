...
let crops = {
  mahindi: {
    ...
    video: `<iframe width="560" height="315" src="https://www.youtube.com/embed/1PPrksKwrP8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
  maharage: {
    title: "Maharage",
    article:
    ...
    video: `<iframe width="560" height="315" src="https://www.youtube.com/embed/Xg874vKWfvM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
  viazi: {
    title: "Viazi",
    article:
    ...
    video: `<iframe width="560" height="315" src="https://www.youtube.com/embed/dwgKymuYhBo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`
    },
};
...
function getSelectedValues(event) {
  ...
  if(mkoa.crops.includes(zaoValue.toLowerCase())){
  ...
  div.innerHTML = `<h2> Kilimo cha ${mazao.title} - ${mkoaValue}</h2>
   <p><i> <b>${mkoaValue}:</b> ${mkoa.summary} </i></p>
    <br><br>
    <b style="font-size: 20px"> Makala:</b>
    <p> ${mazao.article} </p>
    <br><br>
    <b style="font-size: 20px"> Maelekezo kwa Video </b>
    <div class="video-container">${mazao.video} </div>
    `;// Update the values in display
  }else {
    div.innerHTML =  `<h2> Kilimo cha ${zaoValue} - ${mkoaValue}</h2>
    <p><i> <b>Mkoa wa ${mkoaValue} hauna ardhi iliyokidhi kilimo cha  ${zaoValue}</b> </i></p>
